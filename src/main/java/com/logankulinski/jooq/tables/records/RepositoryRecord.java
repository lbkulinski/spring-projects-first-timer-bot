...
public class RepositoryRecord extends UpdatableRecordImpl<RepositoryRecord> implements Record2<Integer, String> {
    ...
    @Override
    public RepositoryRecord value1(Integer value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public RepositoryRecord values(Integer value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public RepositoryRecord(Integer id, String name) {
        super(Repository.REPOSITORY);
